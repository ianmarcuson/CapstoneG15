"""
generar_replicas_farmacia_anticipada.py

Genera X replicas de DatosV2.xlsx cambiando SOLO las simulaciones de llegadas
Poisson en la hoja Motor_Arribos, y luego ejecuta model_interdia_farmacia_anticipada.py
...
Adaptacion de generar_replicas_v3.py para el modelo INTERDIA FARMACIA ANTICIPADA (H450):
  ...
  - Lee/escribe solution_interday_farmacia_anticipada_h450-i.xlsx
  - Llama a model_interdia_farmacia_anticipada.main()

Uso tipico desde la carpeta:
    CapstoneG15/Modelo Interdia Farmacia Anticipada H450

    python generar_replicas_farmacia_anticipada.py --replicas 30 --workers 2 --gurobi-threads 1 --overwrite

Supuestos:
    - Este archivo esta en el mismo directorio que:
        params.py
        model_interdia_farmacia_anticipada.py
...
OUT_TAG = "farmacia_anticipada_h450"
...
def build_model_runner_code(
    ...
    lines.extend([
        "import model_interdia_farmacia_anticipada",
        "model_interdia_farmacia_anticipada.main()",
    ])
    return "\n".join(lines)
...
def resolve_paths(script_dir: Path, args):
    ...
    # Validar que params.py y model_interdia_farmacia_anticipada.py existen en base_dir
    ...
    required_files = [
        base_dir / "params.py",
        base_dir / "model_interdia_farmacia_anticipada.py",
    ]
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Genera replicas Poisson de DatosV2 y ejecuta model_interdia_farmacia_anticipada para cada replica."
    )
    ...
    parser.add_argument("--base-dir", type=str, default=None, help="Directorio donde estan params.py y model_interdia_farmacia_anticipada.py. Default: script dir.")
...
def main() -> None:
    ...
    # -------------------------------------------------------------------------
    print("\nEjecutando model_interdia_farmacia_anticipada por replica...")
