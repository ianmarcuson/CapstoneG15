...
<script>
    ...
    function drawCharts() {
        ...
        for(let d = startDay; d <= endDay; d++) {
            for(let m = 0; m < 56; m += 14) {
                customTickVals.push(d * 56 + m);
                customTickText.push(`Día ${d} - M${m}`);
            }
        }
        ...
        const chairLayout = { ...commonLayout,
            ...
            yaxis: { title: '', gridcolor: '#f1f5f9', autorange: 'reversed', tickmode: 'array', tickvals: customTickVals, ticktext: customTickText },
            shapes: dayShapesH
        };
        ...
        const ganttLayout = { ...commonLayout, 
            margin: { t: 10, r: 10, b: 40, l: 80 }, 
            barmode: 'stack', showlegend: false,
            xaxis: { gridcolor: '#f1f5f9', title: '', tickmode: 'array', tickvals: customTickVals, ticktext: customTickText },
...
if __name__ == "__main__":
    data = load_data("Modelo INTRAdia/475_solution_deldia_v2.xlsx")
