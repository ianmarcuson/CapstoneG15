# py correr_intradia_replicas_farmacia_anticipada_24h.py --replicas 30 --workers-intradia 1 --replica-workers 1 --overwrite


"""
correr_intradia_replicas_farmacia_anticipada_24h.py
...
Uso tipico desde la carpeta:
    CapstoneG15/Modelo INTRAdia V2 Farmacia Anticipada 24h

    py correr_intradia_replicas_farmacia_anticipada_24h.py --replicas 30 --workers-intradia 1

Supuestos por defecto:
    - Este script esta en CapstoneG15/Modelo INTRAdia V2 Farmacia Anticipada 24h
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Ejecuta modelo_intradia_farmacia_anticipada_24h.py para todas las replicas solution_interday-i.xlsx."
    )
